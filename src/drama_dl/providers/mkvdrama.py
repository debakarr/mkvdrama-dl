"""MkvDramaProvider — mkvdrama.net provider for drama-dl.

Extracted from the original mkvdrama_api.py module.  Keeps all existing
functionality: gate/pass flow, AES decryption, _c/ resolution, episode parsing.
"""
...
class MkvDramaProvider(DramaProvider):
    """Provider for mkvdrama.net."""

    @property
    def name(self) -> str:
        return "mkvdrama"

    DOMAINS: list[str] = ["mkvdrama.net"]
    ...
    def resolve_shorteners(self, episodes: list[Episode]) -> None:
        ...
        Playwright, FlareSolverr, and the "no resolver available" case.
        """
